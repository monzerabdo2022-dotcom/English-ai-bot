...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "وهسمعك وأصلحلك نطقك وقواعدك، وأرد عليك برقم صوتي تسمعه عشان تتدرب على الاستماع والنطق!"
    )
        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "At the very end of your message, if they made spelling, grammar, or pronunciation mistakes, "
...
def main() -> None:
    ...
    application.add_handler(MessageHandler(filters.VOICE, handle_voice)) # تم التعديل هنا لتكون صحيحة تماماً
